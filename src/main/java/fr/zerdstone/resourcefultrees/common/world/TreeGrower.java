package fr.zerdstone.resourcefultrees.common.world;
...
public class TreeGrower extends AbstractTreeGrower {
	...
	public TreeGrower(String treeName, Supplier<Block> otherDirt) {
		name = treeName;
		TREE = FeatureUtils.register(treeName,
									 Feature.TREE,
									 new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(RegistryHandler.LOGS.get(treeName).get()),
																					new StraightTrunkPlacer(5, 2, 0),
																					BlockStateProvider.simple(RegistryHandler.LEAVES.get(treeName).get()),
		...
		RegistryHandler.GROWER.put(treeName, this);
	}
