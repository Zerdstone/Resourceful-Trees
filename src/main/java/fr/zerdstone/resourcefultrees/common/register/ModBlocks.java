...
import fr.zerdstone.resourcefultrees.common.block.ModLog;
import fr.zerdstone.resourcefultrees.common.block.ModSapling;
import fr.zerdstone.resourcefultrees.common.block.SimpleBarkRefineryBlock;
	...
	public static final RegistryObject<Block> SIMPLE_BARK_REFINERY = BLOCKS.register("simple_bark_refinery",
																					 () -> new SimpleBarkRefineryBlock(
																							 BlockBehaviour.Properties
																									 ...
																									 .noOcclusion()
																									 .lightLevel((p_50763_) -> p_50763_.getValue(BlockStateProperties.LIT) ? 12 : 0)
																					 ));
