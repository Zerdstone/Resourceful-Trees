...
import fr.zerdstone.resourcefultrees.common.blockentity.SimpleBarkRefineryBlockEntity;
import fr.zerdstone.resourcefultrees.common.inventory.slot.ModFuelSlot;
import fr.zerdstone.resourcefultrees.common.inventory.slot.ModResultSlot;
...
public class SimpleBarkRefineryMenu extends AbstractContainerMenu {
	...
	public SimpleBarkRefineryMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
		super(ModMenuTypes.SIMPLE_BARK_REFINERY_MENU.get(), pContainerId);
		checkContainerSize(inv, NUMBER_OF_SLOT);

		blockEntity = ((SimpleBarkRefineryBlockEntity) entity);
	...
	private static final int TE_INVENTORY_SLOT_COUNT = NUMBER_OF_SLOT; // must be the number of slots you have!
