package fr.zerdstone.resourcefultrees.common.recipe;
...
public class SimpleBarkRefineryRecipe implements Recipe<SimpleContainer> {
	...
	public static class Serializer implements RecipeSerializer<SimpleBarkRefineryRecipe> {
		...
		@Override
		public @NotNull SimpleBarkRefineryRecipe fromJson(@NotNull ResourceLocation id, @NotNull JsonObject json) {
			...
			return new SimpleBarkRefineryRecipe(id, output, inputs);
		}

		@Override
		public SimpleBarkRefineryRecipe fromNetwork(@NotNull ResourceLocation id, FriendlyByteBuf buf) {
